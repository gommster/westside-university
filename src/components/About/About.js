            ...
            <Route path ='/about'
              render = {()=> (
                <div>
                  ...
                  <p>
                    ERMERGER WHAT A GREAT SCHOOL TRULY THE BEST THAT EVER WAS LIKE ASH KETCHUM GOTTA CATCH EM ALL 
                    POKEMON SEALED BOX OPENING ON TWITCH THE BEST STREAMING PLATFORM THERE IS WOW AMAZING
                  </p>
                </div>
              )} />
          </Switch>
